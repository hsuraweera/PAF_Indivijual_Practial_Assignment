    ...
    <div class="container" style="width: 100%;">
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <h4 class="text-center" style="padding-top: 20px;padding-bottom: 20px;">Total Amount : 433$</h4><button class="btn btn-dark" type="button">Buy Now</button>
            </div>
            <div class="col-md-4"></div>
        </div>
    </div>
